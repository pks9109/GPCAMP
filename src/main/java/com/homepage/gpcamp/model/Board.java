...
public class Board {
	...
	private String file_ext_name; 		//파일 서브 이름,    file_tb에서 파일명 가져와서 뿌려줌
	...
	public String toString() {
		return "Board [board_seq=" + board_seq + ", board_division=" + board_division + ", board_notice=" + board_notice
				...
				+ file_ori_name + ", file_sub_name=" + file_sub_name + ", file_ext_name=" + file_ext_name
				+ ", file_path=" + file_path + ", file_hit=" + file_hit + ", file_cnt=" + file_cnt + "]";
	}
